...
export const WORKFLOW_PHASES = [
  ...
  },
  {
    ...
    icon: '🛠️',
    substeps: [
      { id: 'p4_fiche_produit', label: 'Création de la fiche produit (module détaillé) si pas déjà présente au catalogue', type: 'checkbox', outil: { label: 'Ouvrir le Catalogue AFS', page: 'catalogue' } },
      { id: 'p4_communication_montant', label: 'Le formateur communique le montant et le nom du programme au gestionnaire, complète SF, passe le statut à "Completing Admin"', type: 'montant_devis', notifieGestionnaire: true },
      { id: 'p4_devis', label: 'Création du dossier + devis, adressé au cabinet (copie formateur)', type: 'email', templateKey: 'devis', outil: { label: 'Ouvrir Devis & Factures', tab: 'finance' } },
      { id: 'p4_relance_devis', label: 'Relance si besoin (tâche + note SF)', type: 'relance', maxRelances: 3 },
      ...
      { id: 'p4_devis_signe', label: 'Vérification / réception du devis signé', type: 'checkbox', groupe: 'Réception des documents signés', outil: { label: 'Ouvrir Devis & Factures', tab: 'finance' } },
      { id: 'p4_liste_apprenants', label: 'Vérification de la liste des apprenants (nom, prénom, email, téléphone)', type: 'checkbox', groupe: 'Réception des documents signés', outil: { label: 'Ouvrir Participants', tab: 'participants' } },
      ...
      { id: 'p4_devis_signe_smartof', label: 'Ajout du devis signé au dossier', type: 'checkbox', groupe: 'Réception des documents signés', outil: { label: 'Ouvrir Devis & Factures', tab: 'finance' } },
      { id: 'p4_otr', label: 'Création de l’OTR sur SF', type: 'checkbox', groupe: 'Réception des documents signés' },
      { id: 'p4_convention', label: 'Rédaction et envoi de la convention de formation au cabinet', type: 'email', templateKey: 'convention', groupe: 'Réception des documents signés', outil: { label: 'Ouvrir Documents', tab: 'documents' } },
      { id: 'p4_convocation', label: 'Envoi des convocations (J-15 minimum après signature de la convention)', type: 'email', templateKey: 'convocation', groupe: 'Réception des documents signés', outil: { label: 'Ouvrir Documents', tab: 'documents' } },
    ],
  },
  {
    ...
    substeps: [
      ...
      { id: 'p5_quizz_initial', label: 'Envoi du questionnaire pré-formation', type: 'quizz', quizzType: 'pre', groupe: 'Matin' },
      ...
      { id: 'p5_satisfaction_am', label: 'Envoi du questionnaire de satisfaction', type: 'checkbox', conditional: 'journee_entiere', groupe: 'Après-midi (si formation journée entière)', outil: { label: 'Ouvrir Satisfaction', tab: 'satisfaction' } },
  ...
  },
  {
    ...
    substeps: [
      ...
      { id: 'p6_certificat', label: 'Envoi des certificats de réalisation', type: 'email', templateKey: 'certificat', groupe: 'Clôture du dossier', outil: { label: 'Ouvrir Documents', tab: 'documents' } },
      { id: 'p6_attestation', label: 'Envoi des attestations de formation', type: 'email', templateKey: 'attestation', groupe: 'Clôture du dossier', outil: { label: 'Ouvrir Documents', tab: 'documents' } },
      { id: 'p6_rapport_emargement', label: 'Envoi des rapports d’émargement', type: 'checkbox', groupe: 'Clôture du dossier', outil: { label: 'Ouvrir Documents', tab: 'documents' } },
      { id: 'p6_facturation', label: 'Émission de la facture sur Pennylane', type: 'checkbox', groupe: 'Clôture du dossier', outil: { label: 'Ouvrir Devis & Factures', tab: 'finance' } },
